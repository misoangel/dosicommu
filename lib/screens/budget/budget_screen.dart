...
class _BudgetAddScreenState extends State<BudgetAddScreen> {
  BudgetType _type = BudgetType.추경;
  BudgetResult _result = BudgetResult.원안가결;
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle: Text('${member.district} · ${member.party.name}'),
                  trailing: Container(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 8, vertical: 4),
                    decoration: BoxDecoration(
...
class _MemberAddScreenState extends State<MemberAddScreen> {
  ...
  MemberRole _role = MemberRole.위원;
  Party _party = Party.국민의힘;
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _StatRow('원안가결', 원안, Colors.green),
                      _StatRow('수정가결', 수정, Colors.blue),
                      _StatRow('부결', 부결, Colors.red),
                      _StatRow('보류', 보류, Colors.orange),
                    ],
                  ),
                ),
              ),
